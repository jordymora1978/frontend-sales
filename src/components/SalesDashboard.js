...
const SalesDashboard = () => {
  ...
  const mockMessages = {
    ...
    'MLC-2025002': [
      ...
      { id: 3, sender: 'customer', text: 'Perfecto, gracias!', time: '3:00 PM', date: '2025-01-14' }
    ],
    'MPE-2025003': [
    ...
    'MCO-2025004': [
      { id: 1, sender: 'customer', text: 'Necesito factura con datos fiscales', time: '9:00 AM', date: '2025-01-12' },
      { id: 2, sender: 'seller', text: 'Por supuesto, envíenos sus datos fiscales por este medio.', time: '9:15 AM', date: '2025-01-12' }
    ]
  };
  ...
  const mockQuestions = {
    ...
    'MLC-2025002': [
      ...
      { id: 2, question: '¿Hacen envíos a regiones?', answer: 'Sí, enviamos a todo Chile.', time: '3 horas atrás', answered: true }
    ],
    'MPE-2025003': [
      { id: 1, question: '¿Incluye todos los accesorios?', answer: 'Sí, incluye kit completo como se muestra en las fotos.', time: '5 horas atrás', answered: true }
    ],
    'MCO-2025004': [
      { id: 1, question: '¿Es resistente al agua?', answer: 'Pendiente de respuesta', time: '30 minutos atrás', answered: false }
    ]
  };
  ...
  const mockLogistics = {
    ...
    'MLC-2025002': {
      ...
      steps: [
        ...
        { status: 'En centro de distribución', date: '2025-01-14 14:00', completed: true, location: 'Santiago, Chile' },
        { status: 'En camino', date: '2025-01-15 08:00', completed: true, location: 'Valparaíso, Chile' },
        { status: 'Entregado', date: '2025-01-15 16:00', completed: false, location: 'Dirección del cliente' }
      ]
    },
    'MPE-2025003': {
      provider: 'ANICAM',
      tracking: 'ANI-PE-987654321',
      status: 'Procesando',
      steps: [
        { status: 'Orden recibida', date: '2025-01-13 10:00', completed: true, location: 'Lima, Perú' },
        { status: 'Preparando envío', date: '2025-01-14 09:00', completed: true, location: 'Lima, Perú' }
      ]
    },
    'MCO-2025004': {
      provider: 'CHILEXPRESS',
      tracking: 'CHX-CO-123456789',
      status: 'Entregado',
      steps: [
        { status: 'Orden recibida', date: '2025-01-12 08:00', completed: true, location: 'Medellín, Colombia' },
        { status: 'En tránsito', date: '2025-01-12 14:00', completed: true, location: 'Bogotá, Colombia' },
        { status: 'En reparto', date: '2025-01-13 09:00', completed: true, location: 'Cali, Colombia' },
        { status: 'Entregado', date: '2025-01-13 15:00', completed: true, location: 'Dirección del cliente' }
      ]
    }
  };
  ...
  const mockPublications = {
    ...
    'MLC-2025002': {
      ...
      estado: 'Activa',
      stock: 15,
      descripcion: 'Zapatillas deportivas de alta calidad, ideales para running y entrenamiento.',
      plantilla: 'DEPORTES_CALZADO'
    },
    'MPE-2025003': {
      ...
      categoria: 'Electrónicos > Fotografía > Cámaras',
      estado: 'Activa',
      stock: 8,
      descripcion: 'Kit completo de cámara profesional con lente 18-55mm, estuche y accesorios.',
      plantilla: 'FOTOGRAFIA_PROFESIONAL'
    },
    'MCO-2025004': {
      nombre: 'Smart Watch Deportivo con Monitor de Frecuencia Cardiaca',
      precio: 125000,
      moneda: 'COP',
      tipoPublicacion: 'Premium',
      diasEntrega: '3-5 días hábiles',
      categoria: 'Electrónicos > Wearables > Smart Watches',
      estado: 'Activa',
      stock: 32,
      descripcion: 'Reloj inteligente con múltiples funciones deportivas y monitoreo de salud.',
      plantilla: 'WEARABLES_DEPORTIVO'
    }
  };
